...
class DecoderTransformer_v3(nn.Module):
    ...
    def forward(self, inputs1, inputs2):
        ...
        _c3   = self.diff_c3(torch.cat(self.CFM_c3(_c3_1, _c3_2), dim=1)) + F.interpolate(_c4, scale_factor=2, mode="bilinear")
        ...
        _c2   = self.diff_c2(torch.cat(self.CFM_c2(_c2_1, _c2_2), dim=1)) + F.interpolate(_c3, scale_factor=2, mode="bilinear")
        ...
        _c1   = self.diff_c1(torch.cat(self.CFM_c1(_c1_1, _c1_2), dim=1)) + F.interpolate(_c2, scale_factor=2, mode="bilinear")
...
class mmcdnet_2d(nn.Module):
    ...
    def __init__(self, input_nc=3, output_nc=3, decoder_softmax=False, embed_dim=64):
        ...
        self.Tenc_x2    = EncoderTransformer_v3(img_size=512, patch_size = 7, in_chans=input_nc, num_classes=output_nc, embed_dims=self.embed_dims,
        ...
        self.TDec_x2   = DecoderTransformer_v3(input_transform='multiple_select', in_index=[0, 1, 2, 3], align_corners=False, 
                    ...
                    decoder_softmax = decoder_softmax, feature_strides=[2, 4, 8, 16], mlp_ratios=[4, 4, 4, 4],
                    embed_dims=self.embed_dims[::-1], num_heads=[8, 4, 2, 1], sr_ratios=[1, 2, 4, 8])
