...
class snunet_ori(nn.Module):
    # SNUNet-CD with ECAM
    def __init__(self, in_ch=3, out_ch=4, emb_dims=16):
        ...
        #self.post_conv_final = nn.Conv2d(filters[0] * 4, out_ch+1, kernel_size=1)
    ...
    def forward(self, xA, xB):
        ...
        pred_2d = self.conv_final(out)

        
        #post_pred_2d = self.post_conv_final(out)
        #post_pred_3d = self.post_regressor_3d(out)
