...
class siamunet_ef_newB(nn.Module):
    def __init__(self, in_ch=3, out_ch=4, use_dropout=False):
        super().__init__()
    ...
    def forward(self, t1, t2):
        ...
        #x12d = self.do12d(self.conv12d(x11d_3d))
        #x11d = self.conv11d(x12d)+torch.where(x11d_3d > 0, torch.tensor(2), torch.where(x11d_3d < 0, torch.tensor(1), torch.tensor(0)))
