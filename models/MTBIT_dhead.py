...
class MTBIT_dhead(ResNet):
    def __init__(self, input_nc=3, output_nc=3, resnet_stages_num=4,
        ...
        super(MTBIT_dhead, self).__init__(input_nc, output_nc, backbone=backbone,
    ...
    def forward(self, x1, x2):
        ...
        x1_3d = self._forward_transformer_decoder_3d(x1, token1)
        x2_3d = self._forward_transformer_decoder_3d(x2, token2)
