...
class VGG16FeaturePicker(nn.Module):
    def __init__(self, indices=(3,8,15,22,29)):
        super().__init__()
        features = list(vgg16(pretrained=False).features)[:30]
...
class ifn_deep3d_ori(nn.Module):
    def __init__(self, out_ch=3, use_dropout=False):
        super().__init__()
        ...
        #self.o1_conv3 = Conv1x1(512, out_ch)
        ...
        #self.o2_conv4 = Conv1x1(256, out_ch)
        ...
        self.o3_conv4 = Conv1x1(128, out_ch)
        ...
        self.o4_conv4 = Conv1x1(64, out_ch)
        ...
        self.o5_conv4 = Conv1x1(16, out_ch)
