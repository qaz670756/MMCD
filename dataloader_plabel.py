    ...
    def __getitem__(self, i):
        ...
        if self.augmentation:
            ...
            if self.sets_len == 5:
                ...
                t1, t2, mask2d, mask3d, height = sample['image'], sample['t2'], sample['mask'], sample['mask3d'], \
                                                 sample['height']
        ...
        if self.return_crs:
            if self.sets_len == 5:
                return t1, t2, mask2d, mask3d.float(), height.float(), pmask2d, self.t1_images_fps[i]
            else:
                return t1, t2, mask2d, mask3d.float(), pmask2d, self.t1_images_fps[i]
        else:
            if self.sets_len == 5:
                return t1, t2, mask2d, mask3d.float(), height.float(),pmask2d
            else:
                return t1, t2, mask2d, mask3d.float(), pmask2d
