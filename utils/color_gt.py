...
def colorGT(root):
    ...
    for img_path in tqdm(img_list):
        ...
        img = applyColor(img)
        if img.sum()>0:
            save_img_func(img,img_path,'/home/liub/MMCD/utils/gt2D_val',dim=3)

if __name__ == '__main__':
    roots = ['/home/liub/data/amsterdam_025/val/mask2d_1k',
             '/home/liub/data/rotterdam_025/val/mask2d_1k',
             '/home/liub/data/utrecht_025/val/mask2d_1k']
    for root in roots:
        colorGT(root)
